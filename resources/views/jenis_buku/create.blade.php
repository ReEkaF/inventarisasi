    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-50 py-8">
        <div class="max-w-6xl w-full p-8 bg-white rounded-lg shadow-md border-2 border-black">
            <nav class="text-sm text-gray-500 mb-4">
                ...
                <a href="#" class="text-black-500 hover:underline"><b>Jenis Buku</b></a>
            </nav>

            <h2 class="text-lg font-semibold text-gray-800">Tambah Jenis Buku</h2>
            <p class="text-sm text-gray-600 mb-6">Ini adalah halaman untuk menambah Jenis Buku</p>
            ...
            <form action="{{ route('jenis_buku.store') }}" method="POST" >
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_jenis_buku" name="nama_jenis_buku" value="{{ old('nama_jenis_buku') }}" class="w-full border border-black rounded-md p-2.5 focus:outline-none focus:border-blue-500">
