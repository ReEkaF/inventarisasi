  ...
  <div class="flex w-full max-w-2xl bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="w-7/12 p-4 flex flex-col justify-center">
      <div class="flex flex-col items-start p-6">
        <!-- Logo -->
        <img src="/images/logo.webp" alt="Logo" class="h-12 mb-2">
        ...
        <form class="w-full" method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-3">
            <label class="block text-gray-700 text-xs mb-1" for="username">Email</label>
            <div class="flex items-center border rounded-lg focus-within:ring-2 focus-within:ring-blue-500">
              ...
              <!-- Input Field -->
              <input type="text" id="email" name="email" placeholder="email" value="{{ old('email') }}" class="w-full px-2 py-1 focus:outline-none text-xs">
            </div>
            <x-input-error :messages="$errors->get('email')" class="text-xs text-red-500 mt-0.5" />
          </div>
